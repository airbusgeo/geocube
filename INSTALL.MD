...
```bash
$  ./server -ingestionStorage=/tmp -dbConnection=postgresql://postgres:password@localhost:5432/geocube -psEventsTopic events -psConsolidationsTopic consolidations -local
