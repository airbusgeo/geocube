...
[...]
    args:
      - |
        ...
        mkdir -p $WORKDIR;
        /consolidater -psEventTopic events -psSubscription consolidations -workdir $WORKDIR -cancelledJobs=/geocube-cancelled-jobs or gs://my-bucket/geocube-cancelled-jobs || true;
        exitcode=$?;
        rm -rf $WORKDIR;
        exit $exitcode;
```
